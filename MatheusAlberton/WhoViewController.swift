...
class WhoViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func insertData() {
        ...
        var eight = ["Title":"iOS Development","Year":"2015","Description":"I joined BEPiD (Brazilian Education Program for iOS Development) where I'm working just with iOS (Swift and Objective-C). Current studying and very interested about this universe.", "Icon":"ios", "newSkills": "Swift\nXcode\nParse.com\nObjective-C"]
